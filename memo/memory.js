var mem = {
  ...
  // (A2) GAME SETTINGS
  sets : 10, // Total number of cards to match
  ...
  init : function () {
    ...
    for (let i=0; i<mem.sets * 2; i++) {
      ...
      card.innerHTML = `<img src='${mem.url}img0.png'/>`;
      card.dataset.idx = i;
  ...
  open : function () { if (mem.locked == null) { 
    ...
    this.innerHTML = `<img src='${mem.url}img${mem.grid[idx]}.png'/>`;
    this.onclick = "";
  ...
  close : function (aa, bb) {
    ...
    aa.innerHTML = `<img src='${mem.url}img0.png'/>`;
    bb.innerHTML = `<img src='${mem.url}img0.png'/>`;
    aa.onclick = mem.open;
    bb.onclick = mem.open;
    mem.locked = null;
    mem.last = null;
